...
class Question:
    def __init__(self, title: str, text: str, image: str, position: int, possibleAnswers: list):
        ...
        >>> out = Question("Test Question", "Test", "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", 0, [])
        >>> print(out.title)
        Test Question
        >>> print(out.text)
        Test
    ...
    def to_json(self) -> json:
        ...
        >>> question = Question("Test Question", "Test", "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", 0, [])
        >>> out = question.to_json()
        >>> print(out)
        {"title": "Test Question", "text": "Test", "image": "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", "position": 0, "possibleAnswers": []}
        """
    ...
    def from_json(input):
        ...
        >>> jsonStr = {"title": "Test Question", "text": "Test", "image": "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", "position": 0, "possibleAnswers": []}
